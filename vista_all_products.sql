...
/****** Object:  View [dbo].[vw_get_all_products]    Script Date: 06/04/2018 10:36:40 ******/
SET ANSI_NULLS ON
GO
...
create view [dbo].[vw_get_all_products] as
...
, PEXT.DUN14T
, PEXT.[ID de Origen]
, IMPSTS.[Codigo de Categoria Impuesto] as [Codigo de Impuesto],IMPSTS.[Nombre de Impuestos]
